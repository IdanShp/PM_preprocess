...
to_csv_args={ "index_label": "index"}

read_json_args={"convert_dates":False, "convert_axes":False }
to_json_args={"force_ascii":False, "index":True}

json_names= {
    "caseid_file" : "./data_set/caseid_file.json",
    "good_caseid_file" : "./data_set/good_caseid_file.json",
    "bad_caseid_file" : "./data_set/bad_caseid_file.json",
    "zone_caseid_file" : "./data_set/zone_caseid_file.json",
    "zone_good_caseid_file" : "./data_set/good_zone_caseid_file.json",
    "zone_bad_caseid_file" : "./data_set/bad_zone_caseid_file.json"
}

csv_names={
    "players":"./csv/player_good_no_loops_%d_games.csv" % len(matches_include), 
    "players_good":"./csv/player_normal_no_loops_%d_games.csv" % len(matches_include), 
    "players_bad":"./csv/players_bad_no_loops_%d_games.csv" % len(matches_include), 
    "zone":"./csv/zone_good_no_loops_%d_games.csv" % len(matches_include),
    "zone_good":"./csv/zone_normal_no_loops_%d_games.csv" % len(matches_include), 
    "zone_bad":"./csv/zone_bad_no_loops_%d_games.csv" % len(matches_include),
}
#after xes
xes_names={
    ...
    "player_bad_xes_file" : "./xes/player_good_no_loops_%d_games.xes" % len(matches_include),
    ...
    "zone_bad_xes_file" : "./xes/zone_bad_no_loops_%d_games.xes" % len(matches_include),
}
